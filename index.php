...
<head>
	...
	<title>Kuzu Store Próximamente</title>
	<!-- <link name="author" content="Argenis Oldair Palacios Escobar | Julio César Tinoco Marín" /> -->
	<meta name="description" content="Kuzu">
	<!-- Favicons -->
	...
	<meta name="application-name" content="Kuzu" />
	<meta name="apple-mobile-web-app-title" content="Kuzu" />
		...
		<section class="container main-wrapper">
			...
			<section id="logo" class="fade-down">
				<a href="#" title="Kuzu - Próximamente">
					<img src="img/logo.png" style="width:35%;" alt="Kuzu Proximamente">
				</a>
			</section>
			<!-- Logo end here -->
			<!-- Slogan start here -->
			<section class="hidden slogan fade-down">
				<h1>Sorpresas próximamente</h1>
			</section>
			<!-- Slogan end here -->
			...
			<ul class="connect-us row fade-down">
				<li><a href="https://www.facebook.com/kuzu.store/" target="_blank" class="fb tool-tip" title="Facebook"><i class="fa fa-facebook"></i></a></li>
				<li><a href="https://instagram.com/kuzu.store" target="_blank" class="instagram tool-tip" title="Instagram"><i class="fa fa-instagram"></i></a></li>
				<li><a href="https://twitter.com/kuzu_store" target="_blank" class="twitter tool-tip" title="Twitter"><i class="fa fa-twitter"></i></a></li>
			</ul>
		...
		<div class="modal fade bs-example-modal-lg" role="dialog" aria-hidden="true" data-keyboard="true" data-backdrop="static" tabindex="-1">
			...
			<div class="modal-content pop-up">
				...
				<div class="clearfix">
					<div>
						<h4 style="text-align: center;">
							Kuzu, es una empresa Turco-Mexicana, dedicada a la comercialización, distribución y venta de productos, artesanias y accesorios de decoración de origen Turco para uso personal, hogar y organizaciones.
						</h4>
					</div>
				</div>
				<br><br>
				...
				<div class="clearfix">
					<div>
						<h4 style="text-align: center;">
							Contribuir  de  manera  importante  dentro  de  la  industria  de  la  comercialización  de esta   categoria   de   productos,   buscando   enriquecer   visualmente   espacios y propiciando ambientes llenos de armonia y color.
						</h4>
					</div>
				</div>
				<br><br>
				...
				<div class="clearfix">
					<div>
						<h4 style="text-align: center;">
							Formar  parte  de  un  selecto  grupo  de  proveedores,  creciendo  como  empresa comercializadora   de   artesanias,   productos   y   accesorios   de   origen Turco, adaptando  e  impulsando  nuevas  tecnologías  para  la  compra-venta  y  distribución de nuestra categoria de productos hacia nuestros clientes.
						</h4>
					</div>
				</div>
		...
		<div class="modal-dialog modal-lg">
	  		<div class="modal-content pop-up pop-up-cnt">
				...
				if(isset($_POST['submit'])){
					...
					$to="Contacto@kuzu.store"; // Add your e-mail here
					if($code!=$captcha){
				...
				<div class="clearfix cnt-wrap">
					<div class="col-md-4 col-sm-4">
						...
						<h4>Teléfono</h4>
						<p>Oficina: (+52) 01 55 1313 1177<br />Móvil: (+90) 53 4086 8546</p>
					</div>
					<div class="col-md-4 col-sm-4">
						<i class="fa fa-envelope-o"></i>
						<h4>Email</h4>
						<p>Contacto@Kuzu.store<br />Contact@Kuzu.store</p>
					</div>
					<div class="col-md-4 col-sm-4">
						<i class="fa fa-map-marker"></i>
						<h4>Dirección</h4>
						<p>
							Felipe Villanueva Sector 38<br />
							Manzana 122, Lote 4<br />
							Col. Los Héroes Tecámac,<br />
							Tecámac Estado de México.<br />
							Tel.: +52 (55) 1313-1177
						</p>
					</div>
				</div>
